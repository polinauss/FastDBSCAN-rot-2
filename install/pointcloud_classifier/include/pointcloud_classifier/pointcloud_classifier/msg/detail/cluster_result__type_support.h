...
#ifndef POINTCLOUD_CLASSIFIER__MSG__DETAIL__CLUSTER_RESULT__TYPE_SUPPORT_H_
#define POINTCLOUD_CLASSIFIER__MSG__DETAIL__CLUSTER_RESULT__TYPE_SUPPORT_H_
...
#endif  // POINTCLOUD_CLASSIFIER__MSG__DETAIL__CLUSTER_RESULT__TYPE_SUPPORT_H_
